...
<div class="section"> 
		<div class="container">
			<div class="row main">
                ...
                <form method="post" action = "{{url('/')}}/signup" class="login100-form validate-form p-l-55 p-r-55 p-t-20">
					{{ csrf_field() }}
					@if($errors->any())
...
<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="password" class="form-control" name="confirm" id="confirm"  placeholder="Confirm Password" pattern=".{8,}" maxlength="36"  required/>
								</div>
							</div>
						</div>
						</div>  
...
<div class="content-wrapper" style="margin-bottom:20px; margin-top:20px">
    ...
    <!-- /.content --> 
						...
						<div class="form-group ">
                           ...
                           <button target="_blank" name="submit" type="submit" class="btn btn-primary btn-lg btn-block login-button">Sign Up</button>
						</div>
						</div>
						</div>
					</form>
