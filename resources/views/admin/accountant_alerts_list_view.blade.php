                  ...
                  <th>Quantity on Hand</th>
                      ...
                      @if($result>0)
                        ...
                        <tr>
                                    @php
$name = $results->sku;
                    $result1 = DB::select("select* from detail_table where pos = '1' and product_name = '$name' ");
                       ...
                       <td>{{$result2[0]->available_quantity}}</td>
                          ...
                          <td>{{number_format($results->purchase_quantity * $results->purchase_price) }}</td>
                            <td>{{$results->supplier}}</td>
                                   <input name="supplier[]" value="{{$results->supplier}}" type="hidden">
                            <td>{{$results->terms}}</td>
                                   <input name="terms[]" value="{{$results->terms}}" type="hidden">
