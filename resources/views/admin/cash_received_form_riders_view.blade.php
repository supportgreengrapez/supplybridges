     ...
     <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
               <form method="post" action = "{{url('/')}}/admin/home/view/accountant/payment/received" class="login-form" enctype="multipart/form-data">
                      {{ csrf_field() }}
          <!-- Info boxes -->
          <div class="row">			 
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <table id="example9" class="table no-margin">
                      <thead>
                        <tr>
                          <th>O_ID</th>
                          <th>Customer Name</th>
