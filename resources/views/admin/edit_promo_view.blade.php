...
@endif
        ...
        <div class=" col-md-6">
            ...
            <input type="text" id="Discount Amount" name="discount" value="{{$result[0]->discount_amount}}" class="form-control input-sm chat-input" placeholder=" Discount Amount" required/>
            ...
            <input type="text" id="MinSubTotal" name="min" value="{{$result[0]->min_total}}" class="form-control input-sm chat-input" placeholder="Min Sub Total" required />
            
            <label for="text">Max Sub Total</label>
            <input type="text" id="Max Sub Total" name="max" value="{{$result[0]->max_total}}" class="form-control input-sm chat-input" placeholder="Max Sub Total" required />
           ...
           <label for="text">Inactive?</label>
                            <input id="cmn-toggle-4" class="cmn-toggle cmn-toggle-round-flat" type="checkbox" required="required" >
